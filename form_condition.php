<form class="form-inline">
    ...
    <label for="gov" data-tooltip="如：中央政府、臺中市">
        政府
    </label>
...
<form class="form-inline">
    ...
    <label for="start_date" data-tooltip="以出發日期為準">
        起始日期
    </label>
    <input class="form-control" type="date" id="start_date"/>
    <label for="end_date" data-tooltip="以出發日期為準">
        結束日期
    </label>
    <input class="form-control" type="date" id="end_date"/>
    <label for="area" data-tooltip="如：香港、日本，另含中立區、東歐等不明物體">
        前往地區
    </label>
    ...
    <label for="adm_cat" data-tooltip="較細部的分類，例如：工程管理、教育及體育">
        施政分類
    </label>
